...
export class TokenClaim extends ethereum.Event {
  get params(): TokenClaim__Params {
    return new TokenClaim__Params(this);
  }
}

export class TokenClaim__Params {
  _event: TokenClaim;

  constructor(event: TokenClaim) {
    this._event = event;
  }
...
export class ProofOfSub__awardItemResult {
  value0: BigInt;
  value1: string;
...
export class ProofOfSub extends ethereum.SmartContract {
  static bind(address: Address): ProofOfSub {
    return new ProofOfSub("ProofOfSub", address);
  }
  ...
  _ownershipClaimed(param0: Address, param1: Bytes): boolean {
    let result = super.call(
      "_ownershipClaimed",
      "_ownershipClaimed(address,bytes32):(bool)",
      [
  ...
  awardItem(
    ...
    _tokenURI: string,
    _channelId: string
  ): ProofOfSub__awardItemResult {
    let result = super.call(
      "awardItem",
      "awardItem(address,string,string):(uint256,string)",
      [
    ...
    return new ProofOfSub__awardItemResult(
      result[0].toBigInt(),
      result[1].toString()
    );
  }
  ...
  try_awardItem(
    ...
    _tokenURI: string,
    _channelId: string
  ): ethereum.CallResult<ProofOfSub__awardItemResult> {
    let result = super.tryCall(
      "awardItem",
      "awardItem(address,string,string):(uint256,string)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new ProofOfSub__awardItemResult(value[0].toBigInt(), value[1].toString())
    );
  }
